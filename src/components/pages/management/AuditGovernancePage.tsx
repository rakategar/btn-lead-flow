        ...
        <>
          ...
          <section className="panel p-5">
            ...
            <ul className="mt-3 space-y-2 text-sm text-navy">
              <li className="flex items-start gap-2"><span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-primary shrink-0" />Aktifkan MFA untuk seluruh user role Senior Leader dan Leader.</li>
