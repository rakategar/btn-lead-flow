...
const IndexInner = () => {
  ...
  const content = useMemo(() => {
    switch (page) {
      ...
      case "activity": return <ActivityDailyPage extraActivities={scopedActivities} onAddLead={isRM ? () => setOpenAddLead(true) : undefined} onAddActivity={isRM ? () => setOpenAddActivity(true) : undefined} />;
